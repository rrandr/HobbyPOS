...
public class OrderKTV {
    ...
    public OrderKTV(int orderID, String transactionID, int productID, String productName, int pPrice, int qquantity, String tName, String waiterN, String drinks, String dates , String ttime) {
    ...
    public OrderKTV(String transactionID, String tName, String waiterN,String dates){
        this.transactionid = transactionID;
        this.tableName = tName;
        this.waiterName = waiterN;
        this.orderDate= dates;
